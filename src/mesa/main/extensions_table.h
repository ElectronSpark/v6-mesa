...
EXT(ANGLE_client_arrays                     , dummy_true                             , GLL, GLC,  x , ES2, 2016)
EXT(ANGLE_pack_reverse_row_order            , dummy_true                             ,  x ,  x ,  x , ES2, 2011)
EXT(ANGLE_request_extension                 , dummy_true                             , GLL, GLC,  x , ES2, 2016)
EXT(ANGLE_robust_client_memory              , dummy_true                             , GLL, GLC,  x , ES2, 2017)
...
EXT(ANGLE_webgl_compatibility               , dummy_true                             , GLL, GLC,  x , ES2, 2016)
...
EXT(CHROMIUM_bind_generates_resource        , dummy_true                             , GLL, GLC,  x , ES2, 2016)
EXT(CHROMIUM_copy_texture                   , dummy_true                             , GLL, GLC,  x , ES2, 2011)
